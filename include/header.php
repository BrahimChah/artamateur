...
<!-- 						<div class="inscription ins">
						...
						if(isset($id) && $admin==0):
							echo '<div class="col-md-4 col-xs-12 whenconnected">
									<div class="form-group"> 
											...
											<div class="profilbutton"><a href="profil.php" class="connect2" style="color:black">Mon compte</a></div>
				...
				<nav class="navbar navbar-light bg-faded col-md-12 col-xs-12 adjust"><!-- barre de navigation -->
					<ul id="topnav">
						<li class="nav-item active mg col-md-2 col-xs-2"><a href="index.php">Acceuil</a></li>
						<li class="barnav md nav-item col-md-2 col-xs-2"><a href="toutvoir.php">Tout voir</li>
						<?php 
							if (!isset($id)){
								echo '<li class="barnav col-md-2 col-xs-1"><a href="inscription.php">Inscription</a></li>';
							}
						?>
						<li class="barnav col-md-3 col-xs-3"><a href="contact.php">Nous contacter</a></li>
						<li class="barnav col-md-3 col-xs-4"><a href="index.php#qsn">Qui sommes-nous ?</a></li>
					</ul>
				</nav> 
			</header>
